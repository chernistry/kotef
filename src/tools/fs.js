 ...
 */
export function resolvePath(ctx, relativePath) {
 ...
 */
export async function readFile(ctx, relativePath) {
 ...
 */
export async function listFiles(ctx, pattern) {
 ...
 */
export async function writePatch(ctx, relativePath, diffContent) {
    const fullPath = resolvePath(ctx, relativePath);
